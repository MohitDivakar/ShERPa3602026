...
{
    public partial class rptClaimPLData : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    if (Session["USERID"] != null)
                    {
                        ...
                        objBindDDL.FillPlantIsMobex(ddlPlantCode, 1);
        ...
        public void BindGrid()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dtData = objMainClass.GetClaimData(objMainClass.intCmpId, ddlStatus.SelectedIndex == 0 ? 0 : Convert.ToInt32(ddlStatus.SelectedValue), txtFromDocDate.Text, txtToDocDate.Text, txtJobID.Text, ddlPlantCode.SelectedIndex == 0 ? "" : ddlPlantCode.SelectedValue, "", "CS", "PANDLDATA", txtOrderID.Text, txtClaimRefNo.Text);
