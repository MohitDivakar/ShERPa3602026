<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptPBRegister.aspx.cs" Inherits="ShERPa360net.REPORTS.rptPBRegister" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; PB  </strong>Register</h3>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label">PB Date : </label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:LinkButton runat="server" ID="lnkNewPB" CssClass="btn btn-success pull-left" Text="New PB" PostBackUrl="~/MM/CreatePB.aspx"><i class="fa fa-file-text"></i></asp:LinkButton>
                                            <asp:LinkButton runat="server" ID="lnkSerchPO" CssClass="btn btn-success pull-left" Text="Search PB" OnClick="lnkSerchPB_Click"><i class="fa fa-search"></i></asp:LinkButton>
                                            <asp:LinkButton runat="server" ID="lnkExport" CssClass="btn btn-success pull-left" Text="Export PB" OnClick="lnkExport_Click"><i class="fa fa-file"></i></asp:LinkButton>
                                        </div>
                                    </div>
