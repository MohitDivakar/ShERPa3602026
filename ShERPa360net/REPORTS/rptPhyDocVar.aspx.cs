...
{
    public partial class rptPhyDocVar : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetPhyDOcData(txtFromDate.Text, txtToDate.Text, Convert.ToInt32(ddlStatus.SelectedValue), ddlQCResult.SelectedValue, ddlPlant.SelectedValue, "SELECTALL");
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    string attachment = "attachment; filename=PhysicalDocVerifyData.xls";
