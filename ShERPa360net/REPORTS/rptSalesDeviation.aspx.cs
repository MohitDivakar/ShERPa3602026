...
{
    public partial class rptSalesDeviation : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetDeviationReport(objMainClass.intCmpId, txtFromDate.Text, txtToDate.Text, ddlPlantCode.SelectedIndex == 0 ? Convert.ToString(Session["PLANTCD"]) : ddlPlantCode.SelectedValue, "GETREPORTDATA");
