<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptStock.aspx.cs" Inherits="ShERPa360net.REPORTS.rptStock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function BindMakeAssociateModel() {
            ...
            $("#ContentPlaceHolder1_grvChandkheda").DataTable({
                paging: true,
                dom: 'Bfrtip',
                destroy: true,
                buttons: [
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;Stock Report - Storewise</strong></h3>
                        </div>
    ...
    <asp:UpdatePanel ID="upd1" runat="server">
        <%--<Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnSarkhejStore" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="btnChandkhedaStore" EventName="Click" />
        </Triggers>--%>
        <ContentTemplate>
            <div class="page-content-wrap" id="divMain" runat="server" visible="false">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="col-md-5 control-label"></label>
                                                    <div class="col-md-7 col-xs-12">
                                                        <asp:Button ID="btnSarkhejStore" runat="server" Text="Sarkhej Store" CssClass="btn btn-success" OnClick="btnSarkhejStore_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="col-md-5 control-label"></label>
                                                    <div class="col-md-7 col-xs-12">
                                                        <asp:Button ID="btnChandkhedaStore" runat="server" Text="Chandkheda Store" CssClass="btn btn-success" OnClick="btnChandkhedaStore_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="panel-body">
                                <div class="row" style="margin-top: 20px !important;">
                                    ...
                                    <div class="col-md-12" id="divSarkhej" runat="server" visible="true">
                                        <asp:Label ID="lblSarkhejStore" runat="server" Text="Sarkhej Store" Font-Bold="true" Font-Size="Larger"></asp:Label>
                                    ...
                                    <div class="col-md-12" id="divChandkheda" runat="server" visible="true" style="margin-top: 20px !important;">
                                        <asp:Label ID="lblChandkhedaStore" runat="server" Text="Chandkheda Store" Font-Bold="true" Font-Size="Larger"></asp:Label>
                                        <div class="box-body divhorizontal" style="overflow-x: scroll; overflow-y: scroll; max-height: 500px !important;">
                                            <asp:GridView ID="grvChandkheda" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                                CellSpacing="0" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" Width="100%">
                                                <EmptyDataTemplate>
                                                    No Record Found!
                                                </EmptyDataTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmRptStoreStock" runat="server" />
