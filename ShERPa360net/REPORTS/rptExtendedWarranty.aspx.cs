...
{
    public partial class rptExtendedWarranty : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt           = objMainClass.GetExtendedWarrantyDetail(ddlStatus.SelectedValue);
                    if (dt.Rows.Count > 0)
                    {
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    string attachment = "attachment; filename=" + "Extendedwarranty.xls";
