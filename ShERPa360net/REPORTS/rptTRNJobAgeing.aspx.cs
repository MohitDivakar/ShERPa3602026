...
{
    public partial class rptTRNJobAgeing : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            ...
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetTRNAgeing(objMainClass.intCmpId, "502", txtFromDate.Text, txtToDate.Text, ddlPlantCode.SelectedIndex == 0 ? Convert.ToString(Session["PLANTCD"]) : ddlPlantCode.SelectedValue, "TRN1", "TRNAGEING");
