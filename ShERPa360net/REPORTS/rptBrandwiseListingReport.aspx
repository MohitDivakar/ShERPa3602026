<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptBrandwiseListingReport.aspx.cs" Inherits="ShERPa360net.REPORTS.rptBrandwiseListingReport" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; BDO </strong>Rejection Report</h3>
                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <asp:LinkButton runat="server" ID="lnkExport" CssClass="btn btn-success" Text="Export " OnClick="lnkExport_Click"><i class="fa fa-file-download"></i></asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12" style="margin-top: 10px !important;">
                                <div class="box">
                                    <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 1000px !important;">
                                        <asp:Literal runat="server" ID="ltgridhtml"></asp:Literal>
                                       <%-- <asp:GridView ID="gvList" OnRowDataBound="gvList_RowDataBound" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ORDERRECEIVED" HeaderText="ORDERRECEIVED" />
                                                <asp:BoundField DataField="UNLISTED" HeaderText="UNLISTED" />
                                                <asp:BoundField DataField="REJECTED" HeaderText="REJECTED" />
                                                <asp:BoundField  HeaderText="Grand Total" />
