...
{
    public partial class rptApprovedPO : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetOnSales(objMainClass.intCmpId, "", txtFromDate.Text, txtToDate.Text, txtPONO.Text, "APPROVEDPO");
                    if (dt.Rows.Count > 0)
                    {
