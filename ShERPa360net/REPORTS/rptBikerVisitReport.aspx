<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptBikerVisitReport.aspx.cs" Inherits="ShERPa360net.REPORTS.rptBikerVisitReport" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>Biker Visit Report</title>
    <style type="text/css">
        .btnClass {
            height: 32px;
            width: 32px;
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; Biker </strong>Visit Report</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Biker Name : </label>
                                            <div class="col-md-8 col-xs-12">
                                                <div class="input-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <div class="input-group">
                                                    <asp:LinkButton runat="server" ID="lnkSerch" CssClass="btn btn-success " Text="Search Report" OnClick="lnkSerch_Click">
                                    ...
                                    <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                        <asp:GridView ID="gvList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="VISIFEEDBACK" HeaderText="Visit FeedBack" />
                                                ...
                                                <asp:BoundField DataField="LESS8K" HeaderText="Less Then 8K" />
                                                <asp:BoundField DataField="GREATER8K" HeaderText="Greater Then 8K" />
                                                <asp:BoundField DataField="ADDED" HeaderText="Added" />
                                                <asp:BoundField DataField="LESS" HeaderText="Less" />
                                                <asp:BoundField DataField="USERNAME" HeaderText="Biker Name" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmBikerRejectionReport" runat="server" />
