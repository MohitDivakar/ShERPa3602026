<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptBrandwiselisting.aspx.cs" Inherits="ShERPa360net.REPORTS.rptBrandwiselisting" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function LoadChartReport() {
            ...
            //}
            jQuery.ajax({
                url: 'rptBrandwiselisting.aspx/GetChartData',
                type: "POST",
                dataType: "json",
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; Brand wise Listing </strong>Report</h3>
                        </div>
