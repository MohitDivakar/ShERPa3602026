<%@ Page Title="Amount Received at Center Manager" Language="C#" MasterPageFile="~/Samsung/Samsung.Master" AutoEventWireup="true" CodeBehind="frmTCRRCVDCM.aspx.cs" Inherits="ShERPa360net.Samsung.frmTCRRCVDCM" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Amount Received at Center Manager</title>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmTranRcvdByCM" runat="server" />
