<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMobexSellerReturnPDF.aspx.cs" Inherits="ShERPa360net.UTILITY.ViewMobexSellerReturnPDF" %>
...
<body>
   <form id="form1" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmTranMobexVendorReturn" runat="server" />
