...
{
    public partial class ListingTransactionDetail : System.Web.UI.Page
    {
        ...
        public void BindPageDropDown()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    objBindDDL.FillDealer(ddlVendor, 1);
        ...
        public void BindProductDetail()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetVendorListingTransaction(Convert.ToInt32(ddlVendor.SelectedValue));
                    if (dt.Rows.Count > 0)
                    {
