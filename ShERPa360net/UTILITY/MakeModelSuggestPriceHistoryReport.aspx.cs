...
{
    public partial class MakeModelSuggestPriceHistoryReport : System.Web.UI.Page
    {
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                string attachment = "attachment; filename=MakeModelSuggestPriceHistory.xls";
        ...
        public void SearchFunctionality()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetMakeModelSuggestPriceHistory(0, Convert.ToInt32(ddlMake.SelectedValue), modelid,
