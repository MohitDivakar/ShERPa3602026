...
{
    public partial class AutoUnlistedDetail : System.Web.UI.Page
    {
        ...
        public void BindProductDetail()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.GetAutoUnlistedDetail(txtFromDate.Text, txtToDate.Text, "SEARCH");
                    if (dt.Rows.Count > 0)
                    {
        ...
        protected void lnkDownLoadAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Columns.Count > 0)
                {
                    ...
                    string attachment = "attachment; filename=" + "AutoUnlistedDetailReport" + "-DateTime-" + indianTime + ".xls";
