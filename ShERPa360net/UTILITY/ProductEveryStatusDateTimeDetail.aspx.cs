...
{
    public partial class ProductEveryStatusDateTimeDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    txtFromDate.Text = (objMainClass.indianTime.Date.AddDays(-180)).ToString("dd-MM-yyyy"); //Convert.ToDateTime(DateTime.Now).ToShortDateString();
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = objMainClass.GetProductEveryStatusDatetimeDetail(txtFromDate.Text, txtToDate.Text, Convert.ToInt32(ddlStatus.SelectedValue)
                ...
                if (dt.Columns.Count > 0)
                {
                    ...
                    string attachment = "attachment; filename=" + "ProductEveryStatusDatetimeDetail-" + ddlStatus.SelectedItem.Text +"-DateTime-" + indianTime + ".xls";
