...
{
    public partial class frmViewVendorMaster : System.Web.UI.Page
    {
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    DataTable dt = new DataTable();
                    dt = objMainClass.GetVendor(objMainClass.intCmpId, objMainClass.strConvertZeroPadding(vendcode), "", 0, 0, "0", "", 0, "VENDSEARCHONE", txtFromDate.Text, txtToDate.Text);
        ...
        protected void btnImage_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    DataTable dt = new DataTable();
                    dt = objMainClass.GetVendor(objMainClass.intCmpId, objMainClass.strConvertZeroPadding(vendcode), "", 0, 0, "0", "", 0, "SEARCHIMAGE", txtFromDate.Text, txtToDate.Text);
