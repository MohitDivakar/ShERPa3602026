<%@ Page Title="CRM Notification" Language="C#" MasterPageFile="~/CRM/MasterCustomerRltionShipMng.Master" AutoEventWireup="true" CodeBehind="frmCRMNotification.aspx.cs" Inherits="ShERPa360net.CRM.frmCRMNotification" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; View  </strong>Notification</h3>
                        <asp:LinkButton ID="imgCancel" runat="server" CssClass="btn btn-success pull-right" PostBackUrl="~/CRM/frmOldCRMNotification.aspx" Text="Old Notification">Old Notification</asp:LinkButton>
                    </div>
                                    ...
                                    <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                        <asp:GridView ID="gvList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="CCust. Name">
                                                    <ItemTemplate>
