<%@ Page Title="" Language="C#" MasterPageFile="~/MM/MasterMM.Master" AutoEventWireup="true" CodeBehind="frmApprovePO.aspx.cs" Inherits="ShERPa360net.MM.frmApprovePO" EnableEventValidation="false" %>
                                                                ...
                                                                <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="false" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Last PO Dtl." ItemStyle-CssClass="newStock" HeaderStyle-CssClass="newStock">
                                                                            <ItemTemplate>
                                                                                <%--<button type="button" data-toggle="modal" data-target="#modal-oldpo" style="font-size: 12px; letter-spacing: 0px; border: none; background: none; margin-left: -6px" runat="server" onclick="lblOldPONo_Click">
                                                                                    <%# Eval("OLDPONO") %>
                                                                                </button>--%>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Item Detail" ItemStyle-CssClass="newStock" HeaderStyle-CssClass="newStock">
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:Label ID="lblITEMREMARKS" runat="server" Text='<%# Eval("ITEMREMARKS") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <%--<asp:BoundField DataField="POID" HeaderText="Sr. No." />
            ...
            <div class="mb-middle">
                ...
                <div class="mb-footer">
                    <div class="pull-right">
                        ...
                        <%--<asp:LinkButton runat="server" ID="lnkPopApprove" CssClass="btn btn-success pull-left" Text="Approve PR" OnClick="lnkPopApprove_Click" ValidationGroup="ValRej"><i class="fa fa-check-circle"></i> Approve</asp:LinkButton>--%>
...
<%--Commented code by Mohit on 9.9.2023--%>
        ...
        <div class="timeline-item" style="border-bottom: 1px solid #f4f4f4;">
            <div class="box-body pad table-responsive" style="margin: 0px;">
                <table class="table text-center col-sm-12 no-border">
                    ...
                    <tr>
                        <td class="col-md-2" style="vertical-align: middle; text-align-last: left; font-size: 12px;">
                            <p align="left">
                                SR. No. :
                                                                                                        <asp:Label ID="lblCustRemarks" runat="server" Text='<%# Eval("POID") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                            </p>
                        </td>
                        <td class="col-md-2" style="vertical-align: middle; text-align-last: left; font-size: 12px;">
                            <p align="left">
                                Curr. Stock :
                                                                                                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("STOCK") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                            </p>
                        </td>
                        <td class="col-md-2" style="vertical-align: middle; text-align-last: left; font-size: 12px;">
                            <p align="left">
                                <asp:Label ID="Label19" runat="server" Text='<%# Eval("OLDPONO") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <button type="button" data-toggle="modal" data-target="#modal-oldpo" style="font-size: 12px; letter-spacing: 0px; border: none; background: none; margin-left: -6px">
                                    <%# Eval("OLDPONO") %>
                                </button>
                                <br />
                                <asp:Label ID="Label17" runat="server" Text='<%# Eval("OLDPOCREATEDDATE") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                <asp:Label ID="Label20" runat="server" Text='<%# Eval("OLDRATE") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                            </p>
                        </td>
                        <td class="col-md-2" style="vertical-align: middle; text-align-last: left; font-size: 12px;">
                            <p align="left">
                                Item :
                                                                                                        <asp:Label ID="lblInquiryType" runat="server" Text='<%# Eval("ITEMCODE") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                -
                                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("ITEMDESC") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label><br />
                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("ITEMPLANTCD") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                / 
                                                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("ITEMLOCCD") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label><br />
                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("ITEMREMARKS") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:HiddenField ID="hfInqType" runat="server" Value='<%# Eval("ITEMDESC") %>' />
                            </p>
                        </td>
                        <td class="col-md-2" style="vertical-align: middle; text-align-last: right; font-size: 12px;">
                            <p align="left">
                                Item :
                                                                                                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("POQTY") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:Label ID="Label10" runat="server" Text="(Qty)" Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("ITEMBRATE") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:Label ID="Label11" runat="server" Text="(Rate)" Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                (<asp:Label ID="Label7" runat="server" Text='<%# Eval("GSTRATE") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                %)
                                                                                                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("TAXAMT") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:Label ID="Label12" runat="server" Text="(Tax)" Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                <asp:Label ID="Label9" runat="server" Text='<%# Eval("ITEMAMOUNT") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:Label ID="Label13" runat="server" Text="(Amt.)" Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:HiddenField ID="hfInqType" runat="server" Value='<%# Eval("ITEMDESC") %>' />
                            </p>
                        </td>
                        <td class="col-md-2" style="vertical-align: middle; text-align-last: left; font-size: 12px;">
                            <p align="left">
                                Item :
                                                                                                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("PRNO") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                <asp:Label ID="Label16" runat="server" Text='<%# Eval("PRAPRV") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                <asp:Label ID="Label18" runat="server" Text='<%# Eval("MRNO") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <br />
                                <asp:Label ID="Label21" runat="server" Text='<%# Eval("MRAPRV") %>' Font-Size="12px" Style="letter-spacing: 0px;"> </asp:Label>
                                <asp:HiddenField ID="hfInqType" runat="server" Value='<%# Eval("ITEMDESC") %>' />
                            </p>
                        </td>
                    </tr>
