                    ...
                    <div class="card card-flush h-lg-100 border-ra-top ">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="text-gray-700 fw-semibold fs-6 me-2"><span class="text-primary opacity-75-hover fs-6 fw-semibold"><a href="MM/AprvMR.aspx">Aprrove MR </a></span></div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                                <!--end::Statistics-->
                            </div>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="d-flex align-items-senter">
                                    ...
                                    <!--end::Svg Icon-->
                                    <!--begin::Number-->
                                    <span class="text-gray-900 fw-bolder fs-6"><i class='bx bx-check-shield icn-h'></i></span>

                                </div>
                                <div class="text-gray-700 fw-semibold fs-6 me-2"><span class="text-primary opacity-75-hover fs-6 fw-semibold"><a href="SD/frmSODeviationAprv.aspx">Approve SO Deviation </a></span></div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="d-flex align-items-senter">
                                    ...
                                    <!--end::Svg Icon-->
                                    <!--begin::Number-->
                                    <span class="text-gray-900 fw-bolder fs-6"><i class='bx bxl-deviantart icn-h'></i></span>

                                </div>
                                <div class="text-gray-700 fw-semibold fs-6 me-2"><span class="text-primary opacity-75-hover fs-6 fw-semibold"><a href="SD/frmViewSODeviation.aspx">SO Deviation</a></span></div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="text-gray-700 fw-semibold fs-6 me-2"><span class="text-primary opacity-75-hover fs-6 fw-semibold"><a href="SD/frmOpenSO.aspx">Open SO</a></span></div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                ...
                <a href="UTILITY/UtilityModuleDashboard.aspx">
                    <div class="card card-flush h-lg-100 border-ra-top">
                        ...
                        <div class="card-header border-top-none">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">Uttility
                                </span>
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">Project Uttility</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
