                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7 col-xs-12">
                                                                <asp:DropDownList ID="ddlDoctype" runat="server" CssClass="form-control required_text_box" Enabled="false" placeholder="Doc. type"></asp:DropDownList>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7 col-xs-12">
                                                                <asp:DropDownList ID="ddlSegment" runat="server" CssClass="form-control required_text_box" Enabled="false" placeholder="Segment"></asp:DropDownList>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7 col-xs-12">
                                                                <asp:DropDownList ID="ddlDistChnl" runat="server" CssClass="form-control required_text_box" Enabled="false" placeholder="Dist. Chnl."></asp:DropDownList>
