<%@ Page Title="" Language="C#" MasterPageFile="~/SD/SDMaster.Master" AutoEventWireup="true" CodeBehind="BulkSoCreation.aspx.cs" Inherits="ShERPa360net.SD.BulkSoCreation" %>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-12">
                                            <asp:DropDownList ID="ddlPlantLocationUploadFrom" runat="server" CssClass="form-control ddlPlantLocationUploadFrom"  AutoPostBack="false" TabIndex="12">
                                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="DropDown" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="File" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:Label ID="lblPlantLocationUploadFrom" runat="server" ClientIDMode="Static" Style="color: red!important; font-weight: bold!important; display: none">Please Select Upload Type</asp:Label>
                                        </div>
                                    </div>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabid" value="tsmTranBulkSoNameAddUpdate" runat="server" />
