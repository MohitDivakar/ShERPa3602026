<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="frmBERReport.aspx.cs" Inherits="ShERPa360net.TS.frmBERReport" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;BER Report</strong></h3>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 style="color: #f05423">BER Report</h4>
                                    <div class="row">
                                                                ...
                                                                <asp:GridView ID="gvRepairReport"  OnRowDataBound="gvRepairReport_RowDataBound" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Reason For IR">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblTechnicianNo" Text='<%# Bind("REASONFORBERKEY") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Activity -5">
                                                                         ...
                                                                         <asp:TemplateField HeaderText="Cosmetic -3">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblCosmetic3" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                         <asp:TemplateField HeaderText="Cosmetic -4">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblCosmetic4" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Notification User Status">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblUserStatus" Text="ber"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Task User Status">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblsTaskUserStatus" Text="ber"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Notification Status">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblNotificationStatus" Text="ATCO NOCO"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
