<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="DispatchEntry.aspx.cs" Inherits="ShERPa360net.TS.DispatchEntry" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;Dispatch Upload Entry</strong></h3>
                        </div>

                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 style="color: #f05423">Dispatch Entry</h4>
                                    <div class="row">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">Dispatch Upload</legend>
                                            <div class="col-md-12">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="col-md-5 control-label">Dispatch Date</label>
                                                        <div class="col-md-7 col-xs-12">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                                <asp:TextBox  ID="txtDispatchDate" AutoCompleteType="None" runat="server" Text="DD/MM/YYYY" CssClass="form-control datepicker" MaxLength="10"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <asp:GridView ID="gvAssignment" OnRowDataBound="gvAssignment_RowDataBound" TabIndex="9" runat="server" AutoGenerateColumns="false" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="ESN No">
                                                                            <ItemTemplate>
                                                                                <asp:HiddenField runat="server" ID="hdIscorrected" Value='<%# Bind("ISDISPATCHCORRECTED") %>'></asp:HiddenField>
