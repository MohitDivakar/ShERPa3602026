<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="BERTOIREntry.aspx.cs" Inherits="ShERPa360net.TS.BERTOIREntry" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;BER To IR Entry</strong></h3>
                        </div>

                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 style="color: #f05423">BER To IR Entry</h4>
                                    <div class="row">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">BER To IR Upload</legend>
                                            <div class="col-md-12">
                                                <div class="col-md-3">
                                                                ...
                                                                <asp:GridView ID="gvAssignment" OnRowDataBound="gvAssignment_RowDataBound" TabIndex="9" runat="server" AutoGenerateColumns="false" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="ESN No">
                                                                            <ItemTemplate>
                                                                                <asp:HiddenField runat="server" ID="hdIscorrected" Value='<%# Bind("ISBERTOIRCORRECTED") %>'></asp:HiddenField>
