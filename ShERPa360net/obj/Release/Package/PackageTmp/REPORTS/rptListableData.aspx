<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptListableData.aspx.cs" Inherits="ShERPa360net.REPORTS.rptListableData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>Listable Data</title>
            ...
            <div class="col-md-12">
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;Listable Data</strong></h3>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmRptListableData" runat="server" />
