<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptBikerRejectionReport.aspx.cs" Inherits="ShERPa360net.REPORTS.rptBikerRejectionReport" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>BDO Rejection Report</title>
    <style type="text/css">
        .btnClass {
            height: 32px;
            width: 32px;
