<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="VendorListedActivityDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.VendorListedActivityDetail" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong runat="server" id="stProductDetail"><span class="fa fa-file"></span>&nbsp;Vendor Not Active Listing Report</strong></h3>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-3" runat="server">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList ID="ddlReportType" ClientIDMode="Static" runat="server" Width="170" CssClass="form-control">
                                                                <asp:ListItem Text="DATE RANGE LISTING ACTIVITY" Selected="True" Value="DATERANGELISTING"></asp:ListItem>
                                                                <asp:ListItem Text="ZERO LISTING ACTIVITY" Value="NOTSINGLEACTIVITY"></asp:ListItem>
                                                            </asp:DropDownList>
                                                    ...
                                                    <div class="row">
                                                        <fieldset class="scheduler-border">
                                                            ...
                                                            <div class="col-md-12 divhorizontal" style="overflow-x: scroll!important;">
                                                                <asp:GridView ID="gvDealerDetail" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    <EmptyDataTemplate>
                                                                        No Record Found!
                                                                    </EmptyDataTemplate>
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Biker">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblBiker" Text='<%# Bind("BIKER") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="ASM">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblASM" Text='<%# Bind("ASM") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <%--Regular Column --%>
                                                                    </Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabCheckerid" value="tsmMobexSellerBikerStatusReport" runat="server" />
