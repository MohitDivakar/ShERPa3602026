<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="ProductQcApproveDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.ProductQcApproveDetail" EnableEventValidation="false" %>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Mobex Rate" Visible="false">
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:Label runat="server" Style="margin-top: 5px!important;" ID="lblPercentageValue"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabCheckerid" value="tsmTranMobexSellerChecker" runat="server" />
