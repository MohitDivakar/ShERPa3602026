<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="frmBDOAssign.aspx.cs" Inherits="ShERPa360net.UTILITY.frmBDOAssign" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>BDO Mapping</title>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-xs-12">
                                                    <asp:DropDownList ID="ddlBDO" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlBDO_SelectedIndexChanged"
                                                        AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="rfvBDO" runat="server" ControlToValidate="ddlBDO" ForeColor="Red" Display="Dynamic"
                                                        ErrorMessage="Select BDO" InitialValue="0" ValidationGroup="Save">Select BDO</asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </div>
