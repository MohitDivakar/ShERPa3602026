<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="RelistDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.RelistDetail" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong runat="server" id="stProductDetail"><span class="fa fa-file"></span>&nbsp;Relist Detail Report</strong></h3>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ListingType ID">
                                                                         ...
                                                                         <asp:TemplateField HeaderText="Relist Date">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblLISTINGTYPEID" Text='<%# Bind("RELISTEDDATE") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Relist By">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblRELISTBY" Text='<%# Bind("RELISTBY") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
