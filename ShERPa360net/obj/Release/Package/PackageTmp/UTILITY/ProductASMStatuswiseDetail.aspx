<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="ProductASMStatuswiseDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.ProductASMStatuswiseDetail" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong runat="server" id="stProductDetail"><span class="fa fa-file"></span>&nbsp;Product ASM Status Report</strong></h3>
                                                                ...
                                                                <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Appr/Reject Date">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblApprRejectDate" Text='<%# Bind("NEGAPRVDATE") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Appr/Reject By">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblApprRejectBy" Text='<%# Bind("APRVBY") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="UnListed By">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblUnlistedBy" Text='<%# Bind("UNLISTBYNAME") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
