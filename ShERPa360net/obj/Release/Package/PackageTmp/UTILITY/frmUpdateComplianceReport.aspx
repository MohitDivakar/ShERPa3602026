<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/UtilityModule.Master" AutoEventWireup="true" CodeBehind="frmUpdateComplianceReport.aspx.cs" Inherits="ShERPa360net.UTILITY.frmUpdateComplianceReport" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; Upload  </strong>Compliance Report</h3>
                        </div>
                                            ...
                                            <div class="col-md-9 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvDate" runat="server" ControlToValidate="txtDate" ForeColor="Red"
                                                        ErrorMessage="Enter Date" ValidationGroup="valCompliance" Display="Dynamic">Enter Date</asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-xs-12">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvLocation" runat="server" ControlToValidate="ddlLocation" InitialValue="0" ForeColor="Red"
                                                    ErrorMessage="Select Location" ValidationGroup="valCompliance" Display="Dynamic">Select Location</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvInspectedBy" runat="server" ControlToValidate="txtInspectedBy" ForeColor="Red"
                                                    ErrorMessage="Enter Inspected By Name" ValidationGroup="valCompliance" Display="Dynamic">Enter Inspected By Name</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                                    ...
                                    <div class="box">
                                        <div class="box-body divhorizontal" style="overflow-x: scroll; overflow-y: scroll; max-width: unset !important; max-height: unset !important;">
                                            ...
                                            <asp:GridView ID="grvQuestions" runat="server" CssClass="table table-hover table-striped table-bordered nowrap" CellSpacing="0" AutoGenerateColumns="false"
                                                Style="overflow-x: scroll" ShowHeaderWhenEmpty="true"
                                                OnRowDataBound="grvQuestions_RowDataBound">
                                                <RowStyle Wrap="true" />
                                                <EmptyDataTemplate>
                                                    No Records Found !
                                                </EmptyDataTemplate>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Answer">
                                                        <ItemTemplate>
                                                            <asp:RadioButtonList ID="rblAnswer" runat="server" OnSelectedIndexChanged="rblAnswer_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvRemarks" runat="server" ControlToValidate="txtRemarks" ForeColor="Red"
                                                                ErrorMessage="*" ValidationGroup="valCompliance" Display="Dynamic" Enabled="false" Visible="false">*</asp:RequiredFieldValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Upload Photo">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:FileUpload ID="fuImage1" runat="server" Visible="false" />
                                                            <asp:FileUpload ID="fuImage2" runat="server" Visible="false" />
                                                            <span class="error">Required</span>
                                ...
                                <%--<div class="col-md-12" style="padding-top: 10px;">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-8 control-label">5S Checksheet Image Upload : </label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">5S Checksheet Image Upload : </label>
                                            <div class="col-md-8 col-xs-12">
                                                <asp:FileUpload ID="fuImage1" runat="server" />
                                                <asp:RequiredFieldValidator ID="rfvImage1" runat="server" ControlToValidate="fuImage1" ForeColor="Red"
                                                    ErrorMessage="Upload 5S Checksheet Image" ValidationGroup="valCompliance" Display="Dynamic">Upload 5S Checksheet Image</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="fuImage2" ForeColor="Red"
                                                    ErrorMessage="Upload 5S Checksheet Image" ValidationGroup="valCompliance" Display="Dynamic">Upload 5S Checksheet Image</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="fuImage3" ForeColor="Red"
                                                    ErrorMessage="Upload 5S Checksheet Image" ValidationGroup="valCompliance" Display="Dynamic">Upload 5S Checksheet Image</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <center style="padding-top: 10px !important;">
                                    <asp:Button ID="btnSave" runat="server" Text="SAVE" CssClass="btn btn-success pull-center"  ValidationGroup="valCompliance" OnClick="btnSave_Click" OnClientClick="Validate();"  />
