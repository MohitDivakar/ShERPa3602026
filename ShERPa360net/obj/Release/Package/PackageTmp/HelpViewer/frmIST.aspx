<%@ Page Title="" Language="C#" MasterPageFile="~/HelpViewer/Help.Master" AutoEventWireup="true" CodeBehind="frmIST.aspx.cs" Inherits="ShERPa360net.HelpViewer.frmIST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding-left: 300px;">
        <label style="vertical-align: top; font-weight: bold; font-size: 16px">Material Management System --> Inter Stock Transfer (IST) :</label>
        <br />
        <br />
        <table width="583" cellpadding="7" cellspacing="0">
            ...
            <tr valign="TOP">
                ...
                <td width="423" class="TextFormat">
                    <p lang="en-IN">To Transfer Item Stock From One Location To Other</p>
                </td>
            </tr>
            <%--<tr valign="TOP">
                <td width="130" class="TextFormat">
            ...
            <tr valign="TOP">
                ...
                <td width="423" class="TextFormat">
                    <p lang="en-IN">MM --> Indent --> Create IST</p>
                </td>
            </tr>
            <%--<tr valign="TOP">
                <td width="130" class="TextFormat">
        ...
        <p lang="en-IN" class="western TextFormat1" style="text-indent: 0.5in; margin-bottom: 0.14in">
            <img src="Images/View IST.png" name="Picture 14" align="BOTTOM" width="850" height="450" border="0">
        </p>
...
Screen:</b>
        ...
        <ol>
            <li class="TextFormat1">
                <p lang="en-IN" style="margin-bottom: 0.14in" class="TextFormat1">
                    <b>Search : To Show The List Of Transferred Item Stock For Selected Period</b>
                </p>
                <li class="TextFormat1">
                    <p lang="en-IN" style="margin-bottom: 0.14in" class="TextFormat1">
                        <b>Create : To Create New IST Document </b>(WIP)
                    </p>
                    <li class="TextFormat1">
                        <p lang="en-IN" style="margin-bottom: 0.14in" class="TextFormat1">
                            <b>Download : To Download Search IST Data</b>
                        </p>
        </ol>
        ...
        <p lang="en-IN" class="western TextFormat1" style="text-indent: 0.5in; margin-bottom: 0.14in">
            <img src="Images/IST Details.png" name="Picture 14" align="BOTTOM" width="850" height="450" border="0">
        </p>
...
Screen:</b>
        ...
        <ol>
            ...
            <p lang="en-IN" style="margin-bottom: 0.14in" class="TextFormat1">
                <b>Click On "Details" Link. It Will Show Details Of Item Which Are Transferred. </b>
            </p>
        </ol>
