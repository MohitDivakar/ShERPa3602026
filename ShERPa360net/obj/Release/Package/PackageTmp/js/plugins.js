    ...
    var uiElements = function () {
        ...
        var uiDatatable = function () {
            ...
            if ($(".datatable_simple").length > 0) {
                $(".datatable_simple").dataTable({ "ordering": false, "info": false, "lengthChange": false, "searching": false, "scrollX": true,});
            ...
            $(".datatable tfoot th").each(function (i) {
                ...
                if ($(this).text() !== '') {
                    var isStatusColumn = (($(this).text() == 'MSN No') ? true : false);
                    var select = $('<select class="arrowclass"><option value=""></option></select>')
                        .appendTo($(this).empty())
                        .on('change', function () {
                            var val = $(this).val();
