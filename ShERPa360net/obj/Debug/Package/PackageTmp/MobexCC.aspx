<%@ Page Title="Mobex CC" Language="C#" AutoEventWireup="true" CodeBehind="MobexCC.aspx.cs" Inherits="ShERPa360net.MobexCC" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mobex CC</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
                        ...
                        <div class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; View  </strong>Customer Data (Footfall)</h3>
                                </div>
                                            ...
                                            <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                                <asp:GridView ID="gvList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="CONTACTNO" HeaderText="Conatact No." />
                                                        <asp:BoundField DataField="PRODUCT" HeaderText="Product" />
                                                        <asp:BoundField DataField="ATTRIBUTE" HeaderText="Spec Name" />
                                                        <asp:BoundField DataField="ATTRVALUE" HeaderText="Spec Value" />
                                                        <asp:BoundField DataField="LOCATION" HeaderText="Location" />
                                                        <asp:BoundField DataField="REMARKS" HeaderText="Remark" />
                                                        <asp:BoundField DataField="REFF" HeaderText="Reference" />
                                                    </Columns>
                                                </asp:GridView>
                                            </div>
                                        </div>
            ...
            <input type="hidden" id="menutabid" value="tsmMobexCCData" runat="server" />
            <input type="hidden" id="mainmenuid" value="tsmMobexCC" />
