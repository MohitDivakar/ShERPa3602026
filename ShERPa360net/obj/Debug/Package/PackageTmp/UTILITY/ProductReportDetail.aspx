<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="ProductReportDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.ProductReportDetail" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong runat="server" id="stProductDetail"><span class="fa fa-file"></span>&nbsp;Product Report Detail</strong></h3>
                            <asp:LinkButton runat="server" ID="lnkExport" CssClass="btn btn-success pull-right" Text="Export Report" OnClick="lnkExport_Click"><span tooltip="Search" flow="down"><i class="fa fa-search"></i> </span></asp:LinkButton>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="3" ID="ddlMake" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlMake_SelectedIndexChanged" runat="server" CssClass="form-control ddlMake required_text_box"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="4" ID="ddlModel" runat="server" CssClass="form-control ddlModel required_text_box"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="5" ID="ddlStatus" runat="server" CssClass="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="6" ID="ddlActualDays" runat="server" CssClass="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="7" ID="ddlRate" runat="server" CssClass="form-control">
                                                                <asp:ListItem Text="ALL" Value="ALL"></asp:ListItem>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="8" ID="ddlGrade" runat="server" CssClass="form-control">
                                                                <asp:ListItem Text="ALL" Value="ALL"></asp:ListItem>
