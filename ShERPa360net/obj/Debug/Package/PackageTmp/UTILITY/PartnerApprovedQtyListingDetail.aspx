<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="PartnerApprovedQtyListingDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.PartnerApprovedQtyListingDetail" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong runat="server" id="stProductDetail"><span class="fa fa-file"></span>&nbsp;Partner Uploade Listing Detail</strong></h3>
                                                                ...
                                                                <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ASIN">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblAsin" Text='<%# Bind("ASIN") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Total Qty">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblTotalQty" Text='<%# Bind("APRVDQTY") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabCheckerid" value="TSMPARTAPPROVEDUPLOADLISTING" runat="server" />
