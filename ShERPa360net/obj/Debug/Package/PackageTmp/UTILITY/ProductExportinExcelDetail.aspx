<%@ Page Title="" Language="C#" MasterPageFile="~/UTILITY/Utility.Master" AutoEventWireup="true" CodeBehind="ProductExportinExcelDetail.aspx.cs" Inherits="ShERPa360net.UTILITY.ProductExportinExcelDetail" EnableEventValidation="false" %>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:DropDownList TabIndex="2" ID="ddlStatus" runat="server" CssClass="form-control">
                                                                ...
                                                                <asp:ListItem Text="LISTED/JANGAD" Value="120"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabCheckerid" value="TSMMobexSellerLockPriceHistory" runat="server" />
