<%@ Page Title="View Laptop Check List" Language="C#" MasterPageFile="~/CRM/MasterCustomerRltionShipMng.Master" AutoEventWireup="true" CodeBehind="frmViewLaptopCheckList.aspx.cs" Inherits="ShERPa360net.CRM.frmViewLaptopCheckList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>View Laptop Check List</title>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:LinkButton runat="server" ID="lnkSearhSR" CssClass="btn btn-success pull-left" Text="Search Report" OnClick="lnkSearhSR_Click" ValidationGroup="valSearch"><span tooltip="Search" flow="down"><i class="fa fa-search"></i> </span></asp:LinkButton>
                                                    ...
                                                    <div class="panel-body tab-content">
                                                        <div class="box-body divhorizontal" style="overflow-x: scroll; overflow-y: scroll; height: 400px">
                                                            <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="false" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="DTLID" HeaderText="ID" Visible="false" />
                                                                    <asp:BoundField DataField="QUESTIONID" HeaderText="Que. ID" />
