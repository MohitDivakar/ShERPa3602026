                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7 col-xs-12">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="revPOUpload" runat="server" ErrorMessage="Only PDF &Image files are allowed" Style="color: red;"
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                    <asp:GridView ID="gvPOList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="PO No." Visible="true">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblPOEXTENSION" runat="server" Text='<%#Eval("POEXTENSION") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="PO Doc.">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkPOInv" Text="PO Doc." OnClick="lnkPOInv_Click"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                            ...
                            <div class="col-md-6">
                                <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                    <asp:GridView ID="gvGRNList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                        CellSpacing="0" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" Width="100%">
                                        <EmptyDataTemplate>
                                            No Record Found!
                                        </EmptyDataTemplate>
                                        <Columns>
                                            <asp:TemplateField HeaderText="PO No." Visible="true">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblEXTENSION" runat="server" Text='<%#Eval("EXTENSION") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Invoice">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="Invoice" Text="Invoice" OnClick="Invoice_Click"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
