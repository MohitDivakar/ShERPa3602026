<%@ Page Title="" Language="C#" MasterPageFile="~/MM/MasterMM.Master" AutoEventWireup="true" CodeBehind="CreateIST.aspx.cs" Inherits="ShERPa360net.MM.CreateIST" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;Inter Stock Transfer   </strong></h3>
                            ...
                            <asp:LinkButton ID="imgCancel" runat="server" CssClass="btn btn-success pull-right" PostBackUrl="~/MM/ViewMaterialIssue.aspx?REQUESTFORM=IST" Text="Cancel"><i class="fa fa-times"></i></asp:LinkButton>
                        ...
                        <asp:UpdatePanel ID="pnlprimaryDetails" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="ddlFromPlant" EventName="SelectedIndexChanged" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7 col-xs-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtDocDt" runat="server" placeholder="PO Date" class="form-control datepicker" AutoCompleteType="None"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7 col-xs-12">
                                                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control" placeholder="Remarks" Width="500"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-default tabs">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">IST Details</a></li>
                                                </ul>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <asp:DropDownList ID="ddlFromPlant" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlFromPlant_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                                <asp:RequiredFieldValidator ID="rfvToPlant" Style="color: red;" ControlToValidate="ddlFromPlant" runat="server" ValidationGroup="SaveItem"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <asp:DropDownList ID="ddlFromLocation" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlFromLocation_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                                <asp:RequiredFieldValidator ID="rfvToLocation" Style="color: red;" ControlToValidate="ddlFromLocation" runat="server" ValidationGroup="SaveItem"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <%--<asp:TextBox ID="txtCostCenter" runat="server" CssClass="form-control required_text_box" placeholder="Cost Center"></asp:TextBox>--%>
                                                                                <asp:DropDownList ID="ddlCostCenter" runat="server" CssClass="form-control"></asp:DropDownList>
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Style="color: red;" ControlToValidate="ddlCostCenter" runat="server" ValidationGroup="SaveItem"
                                                                                    ErrorMessage="Please Select Cost Center" InitialValue="0">Please Enter Cost Center</asp:RequiredFieldValidator>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="rfvPLant" ControlToValidate="ddlPLant" runat="server" ValidationGroup="SaveItem"
                                                                                    ErrorMessage="Please Select Plant" InitialValue="0">Please Select Plant</asp:RequiredFieldValidator>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <asp:TextBox ID="txtRemark" runat="server" CssClass="form-control" placeholder="Remark" Width="520"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
