<%@ Page Title="" Language="C#" MasterPageFile="~/MM/MasterMM.Master" AutoEventWireup="true" CodeBehind="CreateMaterialConsumption.aspx.cs" Inherits="ShERPa360net.MM.CreateMaterialConsumption" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#txtDocDt").datepicker({ beforeShowDay: ShowDisableDates });
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;Direct Material Consumption </strong></h3>
                            <asp:LinkButton ID="imgCancel" runat="server" CssClass="btn btn-success pull-right" PostBackUrl="~/MM/ViewMaterialIssue.aspx?REQUESTFORM=CM" Text="Cancel"><i class="fa fa-times"></i></asp:LinkButton>
                        ...
                        <asp:UpdatePanel ID="pnlprimaryDetails" runat="server" UpdateMode="Conditional">
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="txtTrackingNO" EventName="TextChanged" />
                            </Triggers>
                            <ContentTemplate>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7 col-xs-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtDocDt" runat="server" placeholder="DD/MM/YYYY" class="form-control datepicker" AutoCompleteType="None"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ValidationGroup="SaveAll" Style="color: red!important;"
                                                            ControlToValidate="txtDocDt" ErrorMessage="Select Valid Date" Type="Date">Select valid date (plus/minus one day) </asp:RangeValidator>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10 col-xs-12">
                                                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control" Style="margin-left: 29px!important; width: 500px!important;" placeholder="Direct Consumption" Text="Direct Consumption" Width="500"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 0px;">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                ...
                                                                                <br />
                                                                                <asp:regularexpressionvalidator id="revAvailablePeriod" runat="server" errormessage="Qty must be greater than 0" style="color: red;" controltovalidate="txtItemQty"
                                                                                    validationexpression="^[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]*$" setfocusonerror="true" validationgroup="SaveItem" xmlns:asp="#unknown">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <asp:DropDownList ID="ddlLocation" runat="server" CssClass="form-control required_text_box" AutoPostBack="true" OnSelectedIndexChanged="ddlLocation_SelectedIndexChanged"></asp:DropDownList>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <asp:TextBox ID="txtTrackingNO" runat="server" CssClass="form-control" placeholder="Tracking No." OnTextChanged="txtTrackingNO_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                                <asp:RequiredFieldValidator ID="rfvTrackingNo" runat="server" Style="color: red;" ControlToValidate="txtTrackingNO" ValidationGroup="SaveItem"
                                                                                    ErrorMessage="Please Enter Tracking No.">Please Enter Tracking No.</asp:RequiredFieldValidator>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabid" value="tsmTranPPDirectCons" runat="server" />
