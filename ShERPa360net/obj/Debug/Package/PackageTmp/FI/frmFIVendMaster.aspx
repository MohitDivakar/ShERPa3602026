<%@ Page Title="" Language="C#" MasterPageFile="~/FI/MasterFI.Master" AutoEventWireup="true" CodeBehind="frmFIVendMaster.aspx.cs" Inherits="ShERPa360net.FI.frmFIVendMaster" %>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <fieldset class="scheduler-border shadow" runat="server" id="dvPersonalDetail" visible="false">
                                            ...
                                            <div class="col-md-12" id="divVendCode" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-12" id="divVendCat" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-12" id="divTitle" runat="server" visible="false">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-12" id="divContactPerson" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="col-md-5 control-label">Name 1 :</label>
                                                        <div class="col-md-7 col-xs-12">
                                                            ...
                                                            <asp:TextBox ID="txtName1" runat="server" CssClass="form-control required_text_box" placeholder="Name 1" TabIndex="5"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfvPersonName" Style="color: red;" ControlToValidate="txtName1" runat="server" ValidationGroup="Save2"
                                                                ErrorMessage="Please Enter Name 1">Enter Name 1</asp:RequiredFieldValidator>
                                                            <asp:RegularExpressionValidator ID="revName1" runat="server" Style="color: red;" ControlToValidate="txtName1" ValidationGroup="Save2" ValidationExpression="^[A-Za-z0-9 _]*$"
                                            ...
                                            <div class="col-md-12" id="divSuggestedName" runat="server" visible="false">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="col-md-5 control-label">Name 2 :</label>
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtName2" runat="server" CssClass="form-control required_text_box" placeholder="Name 2" TabIndex="6"></asp:TextBox>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="revName2" runat="server" Style="color: red;" ControlToValidate="txtName2" ValidationGroup="Save2" ValidationExpression="^[A-Za-z0-9 _]*$"
                                                                Display="Dynamic" ErrorMessage="Special Character are not allowed.">Special Character are not allowed.</asp:RegularExpressionValidator>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12" id="divShortName" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="col-md-5 control-label">Short Name :</label>
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtShortName" runat="server" CssClass="form-control required_text_box" placeholder="Short Name" TabIndex="7"></asp:TextBox>
                                                            <%--<asp:RequiredFieldValidator ID="rfvSuggestedName" Style="color: red;" ControlToValidate="txtSuggestedName" runat="server" ValidationGroup="Save2"
                                                                ErrorMessage="Please Enter Enter Name">Please Enter Vendor Name</asp:RequiredFieldValidator>--%>
                                                            <asp:RegularExpressionValidator ID="revShName" runat="server" Style="color: red;" ControlToValidate="txtShortName" ValidationGroup="Save2" ValidationExpression="^[A-Za-z0-9 _]*$"
                                                                Display="Dynamic" ErrorMessage="Special Character are not allowed.">Special Character are not allowed.</asp:RegularExpressionValidator>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12" id="divContactNo" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="col-md-5 control-label">Contact No :</label>
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtContactNo" runat="server" CssClass="form-control required_text_box" placeholder="Contact No" TabIndex="8" MaxLength="10"></asp:TextBox>
                                            ...
                                            <div class="col-md-12" id="divNext2" runat="server" visible="false">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:LinkButton runat="server" ID="lnkPrev2" CssClass="btn btn-success pull-left" TabIndex="9" Text="Previous" OnClick="lnkPrev2_Click" Visible="false"><i class="fa fa-arrow-circle-left"></i></asp:LinkButton>
                                                        <asp:LinkButton runat="server" TabIndex="10" ID="lnkNext2" CssClass="btn btn-success pull-right" Text="Next" OnClick="lnkNext2_Click" ValidationGroup="Save2"><i class="fa fa-arrow-circle-right"></i></asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="scheduler-border shadow" runat="server" id="dvContactDetail1" visible="false">
                                            ...
                                            <div class="col-md-12" id="divAddress1" runat="server" visible="false">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtAddress1" runat="server" CssClass="form-control required_text_box" TabIndex="11" placeholder="Address 1"></asp:TextBox>
                                            ...
                                            <div class="col-md-12" id="divAddress2" runat="server" visible="false" style="padding-top: 5px;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtAddress2" runat="server" CssClass="form-control" placeholder="Address 2" TabIndex="12"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="divAddress3" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtAddress3" runat="server" CssClass="form-control" placeholder="Address 2" TabIndex="13"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="divNext3" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:LinkButton runat="server" ID="lnkPrev3" CssClass="btn btn-success pull-left" Text="Previous" TabIndex="14" OnClick="lnkPrev3_Click"><i class="fa fa-arrow-circle-left"></i></asp:LinkButton>
                                                        <asp:LinkButton runat="server" ID="lnkNext3" CssClass="btn btn-success pull-right" Text="Next" TabIndex="15" OnClick="lnkNext3_Click" ValidationGroup="Save3"><i class="fa fa-arrow-circle-right"></i></asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="col-md-12" id="divPAN" runat="server" visible="false" style="padding-top: 5px;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtPAN" runat="server" CssClass="form-control " placeholder="PAN" TabIndex="25" MaxLength="10" onfocusout="ValidateFIPanNo()"></asp:TextBox>
                                            ...
                                            <div class="col-md-12" id="divAadhar" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtAadharNo" runat="server" CssClass="form-control" placeholder="Aadhar No" TabIndex="27" MaxLength="12" onfocusout="ValidateFIAdharNo()"></asp:TextBox>
                                            ...
                                            <div class="col-md-12" id="divNext7" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:LinkButton runat="server" ID="lnkNext7" CssClass="btn btn-success pull-right" TabIndex="40" Text="Next" OnClientClick="return ValidateFIPanAdharbtn();" OnClick="lnkNext7_Click" ValidationGroup="Save7"><i class="fa fa-arrow-circle-right"></i></asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="col-md-12" id="divGST" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtGST" runat="server" CssClass="form-control" placeholder="GST" TabIndex="26" MaxLength="15" onfocusout="ValidateFIGSTNO()"></asp:TextBox>
                                            ...
                                            <div class="col-md-12" id="divNext8" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:LinkButton runat="server" ID="lnkNext8" CssClass="btn btn-success pull-right" TabIndex="45" Text="Next" OnClientClick="return ValidateGSTCertificatebtn();" OnClick="lnkNext8_Click" ValidationGroup="Save8"><i class="fa fa-arrow-circle-right"></i></asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="col-md-12" id="divACNo" runat="server" visible="false" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtACNo" runat="server" CssClass="form-control" placeholder="Account No." onfocusout="ValidateAccountNumberFIVendorMaster()" TabIndex="36"></asp:TextBox>
                                            ...
                                            <div class="col-md-12" id="divWalletOwner" runat="server" visible="false" style="padding-top: 5px;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtWalletOwner" runat="server" CssClass="form-control " placeholder="Owner Name" TabIndex="43" AutoPostBack="true"></asp:TextBox>
                                                            <%--OnTextChanged="txtWalletOwner_TextChanged"--%>
