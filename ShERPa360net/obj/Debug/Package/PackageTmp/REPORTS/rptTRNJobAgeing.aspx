<%@ Page Title="In-Transit Ageing" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptTRNJobAgeing.aspx.cs" Inherits="ShERPa360net.REPORTS.rptTRNJobAgeing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <title>In-Transit Ageing</title>
                                    ...
                                    <div class="box-body divhorizontal" style="overflow-x: scroll; overflow-y: scroll; max-height: 500px !important;">
                                        <asp:GridView ID="gvList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="RETURN SO NO." DataField="RETURNSONO" />
                                                <asp:BoundField HeaderText="DC NO." DataField="DCNO" />
                                                <asp:BoundField HeaderText="RETURN DC NO." DataField="RETURNDCNO" />
                                                <asp:BoundField HeaderText="SI NO." DataField="SINO" />
                                                <asp:BoundField HeaderText="RETURN SI NO." DataField="RETURNSINO" />
                                                <asp:BoundField HeaderText="SLR NO." DataField="SLRNO" />
                                                <asp:BoundField HeaderText="OLD JOB ID" DataField="OLDJOBID" />
                                                <asp:BoundField HeaderText="NEW JOB ID" DataField="NEWJOBID"/>
                                                <asp:BoundField HeaderText="SLR DATE" DataField="SLRDATE" />
                                                <asp:BoundField HeaderText="NEW JOB ID DATE" DataField="NEWJOBIDDATE" />
                                                <asp:BoundField HeaderText="AGEING" DataField="AGEING" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmRptTRNAgeing" runat="server" />
