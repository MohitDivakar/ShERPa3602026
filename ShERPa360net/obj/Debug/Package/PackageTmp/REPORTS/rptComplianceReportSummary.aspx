<%@ Page Title="" Language="C#" MasterPageFile="~/REPORTS/Report.Master" AutoEventWireup="true" CodeBehind="rptComplianceReportSummary.aspx.cs" Inherits="ShERPa360net.REPORTS.rptComplianceReportSummary" EnableEventValidation="false" %>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp; View  </strong>Comapliance Report Summary</h3>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                        <asp:GridView ID="grvComplianceReportSummary" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
