<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="RepairEntry.aspx.cs" Inherits="ShERPa360net.TS.RepairEntry" %>
                        ...
                        <asp:UpdatePanel ID="pnlprimaryDetails" runat="server" UpdateMode="Always" ChildrenAsTriggers="true">
                            ...
                            <ContentTemplate>
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;Repair Entry</strong></h3>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border">Repair Entry</legend>
                                                    <div class="col-md-12">
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-12" style="margin-top: 10px!important;">
                                                        ...
                                                        <div class="col-md-3" runat="server" visible="false">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-7 col-xs-12">
                                                                    <asp:DropDownList ID="ddlCondition" TabIndex="16" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        ...
                                                        <div class="col-md-3" runat="server" visible="false">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-7 col-xs-12">
                                                                    <asp:DropDownList ID="ddlRepair" TabIndex="17" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <fieldset class="scheduler-border">
                                                                    ...
                                                                    <div class="col-md-12 divhorizontal" style="overflow-x: scroll;">
                                                                        <asp:GridView ID="gvAssignment" TabIndex="28" OnRowCommand="gvAssignment_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                            <Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabid" value="tsmTranTATASKYREPAIRENTRY" runat="server" />
