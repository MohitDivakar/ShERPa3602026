<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="frmRepairReport.aspx.cs" Inherits="ShERPa360net.TS.frmRepairReport" EnableEventValidation="false" %>
                                                                ...
                                                                <asp:GridView ID="gvRepairReport"  OnRowDataBound="gvRepairReport_RowDataBound" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Reason For IR">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblTechnicianNo" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Activity -8">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblActivity8"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Activity -9">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblActivity9"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Notification User Status">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblUserStatus" Text='<%# Bind("NotificationStatus") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Notification Status">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="lblNotificationStatus" Text="NOPR"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
