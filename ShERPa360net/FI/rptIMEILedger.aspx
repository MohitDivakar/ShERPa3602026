<%@ Page Title="" Language="C#" MasterPageFile="~/FI/MasterFI.Master" AutoEventWireup="true" CodeBehind="rptIMEILedger.aspx.cs" Inherits="ShERPa360net.FI.rptIMEILedger" EnableEventValidation="false" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;IMEI wise Ledger </strong></h3>
                            <div class="panel-body">
                                <div class="row">
                                        ...
                                        <div class="box">
                                            <div class="box-body divhorizontal" style="overflow-x: scroll; max-height: 500px !important;">
                                                <asp:GridView ID="gvList" runat="server" CssClass="table table-hover table-striped table-bordered nowrap"
                                                    CellSpacing="0" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" Width="100%" ShowFooter="false">
                                                    <EmptyDataTemplate>
                                                        No Record Found!
                                                    </EmptyDataTemplate>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="DOCNO" HeaderText="Voucher No." />
                                                        <asp:BoundField DataField="DOCDT" HeaderText="Payment Dt." />
                                                        <asp:BoundField DataField="PARTYAC" HeaderText="Vendor Code" />
                                                        ...
                                                        <asp:BoundField DataField="ADJAMT" HeaderText="Doc. Amt." />
                                                        <asp:BoundField DataField="CRDR" HeaderText="CR/DR" />
                                                        <asp:BoundField DataField="DOCAMT" HeaderText="Paid Amt." />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    ...
    <input type="hidden" id="menutabid" value="tsmVendLedger" runat="server" />
