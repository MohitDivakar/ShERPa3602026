                                            ...
                                            <div class="col-md-12" id="divACNo" runat="server" visible="true" style="margin-top: 5px !important;">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7 col-xs-12">
                                                            <asp:TextBox ID="txtACNo" runat="server" CssClass="form-control" placeholder="Account No." TabIndex="36" OnTextChanged="txtACNo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <asp:Label ID="lblAccntNoExist" CssClass="lblpaymentto" runat="server" ClientIDMode="Static" Style="color: red!important; font-weight: bold!important;" Visible="false">Account No already exists.</asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
