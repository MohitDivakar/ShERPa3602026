...
{
    public partial class frmCMSFormat : System.Web.UI.Page
    {
        ...
        protected void lnkSerch_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt = objMainClass.CMSFORMAT(objMainClass.intCmpId, rblBank.SelectedValue, txtFromDate.Text, txtToDate.Text, "CMSUPLOAD");
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    string attachment = "attachment; filename=" + rblBank.SelectedValue + " - " + DateTime.Now + ".xls";
