                                                ...
                                                <fieldset class="scheduler-border">
                                                    ...
                                                    <fieldset class="scheduler-border">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="col-md-5 control-label">Part Location. :</label>
                                                                    <div class="col-md-7 col-xs-12">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-7 col-xs-12">
                                                                        <asp:DropDownList ID="ddlPartName" TabIndex="23" runat="server" CssClass="form-control ddlPartName"></asp:DropDownList>
                                                                        <asp:RequiredFieldValidator ID="rfvPartName" Style="color: red;" ControlToValidate="ddlPartName" runat="server" ValidationGroup="SavePart"
                                                                            ErrorMessage="Please Select Part Name" InitialValue="0">Please Select Part Name</asp:RequiredFieldValidator>
                                                                    </div>
                                                                </div>
                                                            </div>
