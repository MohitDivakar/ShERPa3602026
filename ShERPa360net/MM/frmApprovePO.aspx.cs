...
{
    public partial class frmApprovePO : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    {
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal", "$('#modal-warning').modal();$('#lblAlertMsg').text('You are not authorized to view this page');setTimeout(function () { window.location.href = 'MMDashboard.aspx'; }, 2000);", true);
                    }
                }
                else
                {
            ...
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    if (dtPOMST.Rows.Count > 0)
                    {
                        ...
                        hfMREXTENSION.Value = Convert.ToString(dtPOMST.Rows[0]["MREXTENSION"]);
                        hfMRNO.Value = Convert.ToString(dtPOMST.Rows[0]["MRNO"]);
                        ...
                        txtPODetail.Text = "Order No. : " + Convert.ToString(dtPOMST.Rows[0]["PONO"]) + System.Environment.NewLine + ""
                                         ...
                                         + "Purchase Type : " + Convert.ToString(dtPOMST.Rows[0]["PURCTYPE"]) + System.Environment.NewLine + ""
            ...
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    if (result == true)
                    {
                        ...
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal", "$('#modal-success').modal();$('#lblSuccessMsg').text('PO rejected successfully!');setTimeout(function () { window.location.href = 'frmApprovePO.aspx'; }, 2000);", true);
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal", "$('#modal-warning').modal();$('#lblAlertMsg').text('PO not Rejected. Something went wrong. Please try again!');setTimeout(function() {$('#modal-warning').modal('hide');}, 2000);", true);
                    }
            ...
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    if (result == true)
                    {
                        ...
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal", "$('#modal-success').modal();$('#lblSuccessMsg').text('PO Approved successfully!');setTimeout(function () { window.location.href = 'frmApprovePO.aspx'; }, 2000);", true);
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal", "$('#modal-warning').modal();$('#lblAlertMsg').text('PO not approved. Something went wrong. Please try again!');setTimeout(function() {$('#modal-warning').modal('hide');}, 2000);", true);
                    }
