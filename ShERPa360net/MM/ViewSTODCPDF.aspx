<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSTODCPDF.aspx.cs" Inherits="ShERPa360net.MM.ViewSTODCPDF" %>
...
<body>
    ...
    <input type="hidden" id="menutabid" value="tsmRptDocSTODc" runat="server" />
