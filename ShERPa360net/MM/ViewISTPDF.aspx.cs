...
{
    public partial class ViewISTPDF : System.Web.UI.Page
    {
                    ...
                    if (Session["USERID"] != null)
                    {
                        ...
                        else
                        {
                            if (Session["rptDOCNO"] != null && Convert.ToString(Session["rptDOCNO"]) != "" && Convert.ToString(Session["rptDOCNO"]) != string.Empty)
                            {
                                ...
                                dt = objMainClass.ISTREPORT(objMainClass.intCmpId, Convert.ToString(Session["rptDOCNO"]));
                                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                                ReportViewer1.LocalReport.ReportPath = "Report/rptISTDoc.rdlc";
