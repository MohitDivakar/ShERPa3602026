...
{
    public partial class ViewSTODCPDF : System.Web.UI.Page
    {
                    ...
                    if (Session["USERID"] != null)
                    {
                        ...
                        else
                        {
                            if (Session["rptDOCNO"] != null && Convert.ToString(Session["rptDOCNO"]) != "" && Convert.ToString(Session["rptDOCNO"]) != string.Empty)
                            {
                                ...
                                dt = objMainClass.STOREPORT(objMainClass.intCmpId, "601",Convert.ToString(Session["rptDOCNO"]));
                                ReportViewer1.ProcessingMode = ProcessingMode.Local;

                                ReportViewer1.LocalReport.ReportPath = "Report/rptSTODC.rdlc";
                                ReportDataSource rds = new ReportDataSource("dsMMDocs", dt);
