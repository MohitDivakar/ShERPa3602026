...
{
    public partial class MasterMM : System.Web.UI.MasterPage
    {
        ...
        //protected void btnMPOK_Click(object sender, EventArgs e)
        //{
        //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal", "$('#modal-danger').modal('hide');", true);
        //}
    }
}