...
{
    public partial class frmIRReport : System.Web.UI.Page
    {
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                string filename = "IR Report" + txtFromDate.Text + "-" + txtToDate.Text;
        ...
        public void BindIRReport()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt                             = objMainClass.GetTaTaSkyIRReportforSAPUpload(txtFromDate.Text, txtToDate.Text);
