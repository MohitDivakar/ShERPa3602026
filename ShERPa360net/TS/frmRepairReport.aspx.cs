...
{
    public partial class frmRepairReport : System.Web.UI.Page
    {
        ...
        protected void lnkExport_Click(object sender, EventArgs e)
        {
            try
            {
                string filename = "Repair Report" + txtFromDate.Text + "-" + txtToDate.Text;
        ...
        public void BindRepairReport()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dt                             = objMainClass.GetTaTaSkyRepairReportforSAPUpload(txtFromDate.Text, txtToDate.Text);
