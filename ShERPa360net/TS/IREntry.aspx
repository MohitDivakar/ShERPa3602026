<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="IREntry.aspx.cs" Inherits="ShERPa360net.TS.IREntry" %>
                        ...
                        <asp:UpdatePanel ID="pnlprimaryDetails" runat="server" UpdateMode="Always" ChildrenAsTriggers="true">
                            ...
                            <ContentTemplate>
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><span class="fa fa-file"></span>&nbsp;BER/IR Entry</strong></h3>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border">BER/IR Entry</legend>
                                                    <div class="col-md-12">
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-12" style="margin-top: 10px!important;">
                                                        ...
                                                        <div class="col-md-3" style="display: none">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-7 col-xs-12">
                                                                    <asp:DropDownList ID="ddlRepariTask" Enabled="false" TabIndex="21" runat="server" CssClass="form-control ddlRepariTask"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="col-md-5 control-label">IR/BER Date</label>
                                                                <div class="col-md-7 col-xs-12">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                                        <asp:TextBox ID="txtIRDate" TabIndex="22" Enabled="false" PlacHolder="DD-MM-YYYY" runat="server" CssClass="form-control datepicker required_text_box" MaxLength="10"></asp:TextBox>
                                                                    </div>
                                                                    <asp:RequiredFieldValidator ID="rfvIRDate" Style="color: red;" ControlToValidate="txtIRDate" runat="server" ValidationGroup="SaveAll"
                                                                        ErrorMessage="Please Select IR/BER Date">Please Select IR/BER Date</asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12" style="margin-top: 10px!important;">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="col-md-5 control-label">IR/BER Reason. :</label>
                                                                <div class="col-md-7 col-xs-12">
                                                                    <asp:DropDownList ID="ddlIRReason" TabIndex="23" runat="server" CssClass="form-control ddlIRReason"></asp:DropDownList>
                                                                    <asp:RequiredFieldValidator ID="rfvddlIRReason" Style="color: red;" ControlToValidate="ddlIRReason" runat="server" ValidationGroup="SaveAll"
                                                                        ErrorMessage="Please Select IR/BER Reason" InitialValue="0">Please Select IR/BER Reason</asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <fieldset class="scheduler-border">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="col-md-5 control-label">Part Type. :</label>
                                                                    <div class="col-md-7 col-xs-12">
                                                                        <asp:DropDownList ID="ddlPartType" TabIndex="22" runat="server" CssClass="form-control ddlPartType"></asp:DropDownList>
                                                                        <asp:RequiredFieldValidator ID="rfvddlPartType" Style="color: red;" ControlToValidate="ddlPartType" runat="server" ValidationGroup="SavePart"
                                                                            ErrorMessage="Please Select Part Type" InitialValue="0">Please Select Part Type</asp:RequiredFieldValidator>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Part Location">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:HiddenField runat="server" ID="hdparttypekey" Value='<%# Bind("PARTTYPEKEY") %>'></asp:HiddenField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Part Type">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" ID="lblPartType" Text='<%# Bind("PARTTYPEKEYVALUE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <div class="col-md-12 divhorizontal" style="overflow-x: scroll;">
                                                                        <asp:GridView ID="gvAssignment" OnRowCommand="gvAssignment_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="table items table-striped table-bordered table-condensed table-hover sortable_table" Width="100%">
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="IR Date">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblIRDate" Text='<%# Bind("IRDATE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="IR Reason">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblReason" Text='<%# Bind("REASONFORIRKEYVALUE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
