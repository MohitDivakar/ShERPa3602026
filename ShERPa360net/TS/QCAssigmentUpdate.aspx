<%@ Page Title="" Language="C#" MasterPageFile="~/TS/MasterTS.Master" AutoEventWireup="true" CodeBehind="QCAssigmentUpdate.aspx.cs" Inherits="ShERPa360net.TS.QCAssigmentUpdate" %>
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Date">
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <asp:Label runat="server" ID="lblModel" Text='<%# Bind("MODELSKEYVALUE") %>' Visible="false"></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Object Part" ControlStyle-Width="80">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblObjectPart" Text='<%# Bind("OBJECTPARTKEYVALUE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Fault Observed" ControlStyle-Width="80">
                                                                                    <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Fault Reason" ControlStyle-Width="80">
                                                                                    <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Action" ControlStyle-Width="80">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblAction" Text='<%# Bind("ACTIONKEYVALUE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Part Name" ControlStyle-Width="100">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblPartName" Text='<%# Bind("PARTNAME") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Part Location" ControlStyle-Width="100">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblPartLocation" Text='<%# Bind("PARTLOCATION") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Reason For IR" ControlStyle-Width="80">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" ID="lblReasonForIR" Text='<%# Bind("REASONFORIRKEYVALUE") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Qc Result" ControlStyle-Width="130">
                                                                                    <ItemTemplate>
                                                                                        <asp:DropDownList ID="ddlQcResult" ClientIDMode="Static" runat="server" CssClass="form-control ddlQcResult"></asp:DropDownList>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Qc Fail Reason" ControlStyle-Width="130">
                                                                                    <ItemTemplate>
                                                                                        <asp:DropDownList ID="ddlQcFailReason" ClientIDMode="Static" runat="server" CssClass="form-control ddlQcFailReason"></asp:DropDownList>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                            </Columns>
                                                                        </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <input type="hidden" id="menutabid" value="tsmTranTATASKYQCRESULTUPDATE" runat="server" />
