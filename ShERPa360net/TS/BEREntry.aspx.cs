...
{
    public partial class BEREntry : System.Web.UI.Page
    {
        ...
        protected void imgSaveAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["USERID"] != null)
                {
                    ...
                    result = objMainClass.SAVEBERDETAIL(txtAssignmentNo.Text, txtBERDate.Text,
                        Convert.ToInt32(ddlBERReason.SelectedValue),
                        ...
                        Convert.ToInt32(ddlRepariTask.SelectedValue),
        ...
        protected void txtEsnNo_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    {
                        var dtAssigmentDetail = objMainClass.GETTATASKYJOBASSIGNMENTFORPRESCANREPAIRSTAGE(txtEsnNo.Text, "BEREACHSEARCH");
                        if (dtAssigmentDetail.Rows.Count > 0)
                        {
                            ...
                            txtBERDate.Text = dtAssigmentDetail.Rows[0]["BERDATE"].ToString();
                            ddlBERReason.SelectedValue = dtAssigmentDetail.Rows[0]["REASONFORBERKEY"].ToString();

                            //Load IR Parts Detail Detail
                            var dtPartDetail = objMainClass.GetPartsDetail(txtAssignmentNo.Text, "BER");
                        ...
                        else
                        {
                            ...
                            ddlBERReason.SelectedValue = "0";
                            txtBERDate.Text = objMainClass.indianTime.Date.ToString("dd-MM-yyyy");
                            ViewState["PartData"] = null;
                            gvPartDetail.DataSource = (DataTable)ViewState["PartData"];
                            gvPartDetail.DataBind();
                            SetupPartGrid();
                ...
                if (Session["USERID"] != null)
                {
                    ...
                    if (gvPartDetail.Rows.Count > 0)
                    {
                        ...
                        dt.Rows.Add(id, Convert.ToInt32(ddlPartLocation.SelectedValue), location,
                                0, partname, txtAssignmentNo.Text, 0);
                    ...
                    else
                    {
                        ...
                        dt.Rows.Add(Convert.ToInt32(1), Convert.ToInt32(ddlPartLocation.SelectedValue), location,
                                    0, partname, txtAssignmentNo.Text, Convert.ToInt32(0));
                        ViewState["PartData"] = dt;
                        gvPartDetail.DataSource = (DataTable)ViewState["PartData"];
                        gvPartDetail.DataBind();
                        ResetPartControl("entry");
        ...
        public void BindPageDropDown()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    objBindDDL.FillTaTaSkyReqDropDown(ddlRepariTask, "REPAIR");
                    ddlRepariTask.SelectedValue = "0";

                    // Bind the IRReason Detail 
                    objBindDDL.FillTaTaSkyReqDropDown(ddlBERReason, "REASONFORBER");
                    ddlBERReason.SelectedValue = "0";

                    // Bind the Part Location 
                    objBindDDL.FillTaTaSkyReqDropDown(ddlPartLocation, "PARTLOCATION");
        ...
        public void BindBERRepairGrid()
        {
            try
            {
                if (Session["USERID"] != null)
                {
                    ...
                    dtIRDetail = objMainClass.GETTATASKYJOBASSIGNMENTFORPRESCANREPAIRSTAGE(txtEsnNo.Text, "BERSEARCH");
